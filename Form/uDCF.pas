...
type
  TfrmDCF = class(TForm)
    ...
    sApproved: TShape;
    Label30: TLabel;
    dtpDateOfApproval: TDateTimePicker;
    Panel15: TPanel;
    ...
    procedure chkbYes1Click(Sender: TObject);
    procedure chkbNo1Click(Sender: TObject);
    procedure chkbYes2Click(Sender: TObject);
    procedure chkbNo2Click(Sender: TObject);
    procedure chkbYes3Click(Sender: TObject);
    procedure chkbNo3Click(Sender: TObject);
    procedure chkbYes4Click(Sender: TObject);
    procedure chkbNo4Click(Sender: TObject);
  private
...
{-----------------------------------CheckBox-----------------------------------}
procedure TfrmDCF.chkbNo1Click(Sender: TObject);
var
  value: String;
begin
  if chkbNo1.Checked then
  begin
    value := 'No';
    chkbYes1.Checked := False;
  end;
end;

procedure TfrmDCF.chkbNo2Click(Sender: TObject);
var
  value: String;
begin
  if chkbNo2.Checked then
  begin
    value := 'No';
    chkbYes2.Checked := False;
  end;
end;

procedure TfrmDCF.chkbNo3Click(Sender: TObject);
var
  value: String;
begin
  if chkbNo3.Checked then
  begin
    value := 'No';
    chkbYes3.Checked := False;
  end;
end;

procedure TfrmDCF.chkbNo4Click(Sender: TObject);
var
  value: String;
begin
  if chkbNo4.Checked then
  begin
    value := 'No';
    chkbYes4.Checked := False;
  end;
end;

procedure TfrmDCF.chkbYes1Click(Sender: TObject);
var
  value: String;
begin
  if chkbYes1.Checked then
  begin
    value := 'Yes';
    chkbNo1.Checked := False;
  end;
end;

procedure TfrmDCF.chkbYes2Click(Sender: TObject);
var
  value: String;
begin
  if chkbYes2.Checked then
  begin
    value := 'Yes';
    chkbNo2.Checked := False;
  end;
end;

procedure TfrmDCF.chkbYes3Click(Sender: TObject);
var
  value: String;
begin
  if chkbYes3.Checked then
  begin
    value := 'Yes';
    chkbNo3.Checked := False;
  end;
end;

procedure TfrmDCF.chkbYes4Click(Sender: TObject);
var
  value: String;
begin
  if chkbYes4.Checked then
  begin
    value := 'Yes';
    chkbNo4.Checked := False;
  end;
end;
